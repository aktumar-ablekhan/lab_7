...
music_folder = "C:/Users/User/Desktop/Lab_7"
...
pygame.display.set_caption("Jah Khalib")
clock = pygame.time.Clock()

# артқы фонды енгіземіз
background = pygame.transform.scale(pygame.image.load(os.path.join("Jah.png")), (800, 800))
...
playb = pygame.image.load(os.path.join("play.png"))
pausb = pygame.image.load(os.path.join("pause.png"))
nextb = pygame.image.load(os.path.join("next.png"))
prevb = pygame.image.load(os.path.join("back.png"))
